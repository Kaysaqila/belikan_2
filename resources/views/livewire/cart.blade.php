<div class="bg-white min-h-screen">
    ...
    <div class="px-6 mt-6">
        ...
        @forelse ($cartItems as $item)
            <div class="grid grid-cols-5 items-center border p-4 rounded-b mb-4">
                <!-- Gambar dan checkbox -->
    ...
    <div class="bg-gray-200 mt-10 p-4">
        <div class="flex justify-between items-center mb-4">
            <div class="flex items-center space-x-2 font-semibold">
                <svg class="w-6 h-6 fill-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21 7v10H3V7h18m0-2H3a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Z"/></svg>
